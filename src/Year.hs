...
threeMonthHeader monthRow =
  yearPadding $ take 3 $ drop ((monthRow - 1) * 3) monthNamePaddedArr

pack20 :: String -> String
pack20 = unpack . justifyLeft 20 ' ' . pack . rstrip

threeMonthsWeekNumbers :: Week -> MonthRow -> Year -> String
threeMonthsWeekNumbers (Week week) monthRow year = yearPadding
...
threeMonths monthRow year = yearNewLine
  [ threeMonthHeader monthRow
  , yearDaysOfWeek
